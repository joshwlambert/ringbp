...
- test_sensitivity:
  ...
  pathway (see
  [`outbreak_step()`](https://epiforecasts.io/ringbp/dev/reference/outbreak_step.md)
...
#> function (t) 
#> rep(x, length(t))
#> <bytecode: 0x562d15f73c90>
#> <environment: 0x562d137b3550>
#> 
#> attr(,"class")
