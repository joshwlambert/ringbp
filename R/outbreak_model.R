...
outbreak_model <- function(initial_cases,
  ...
  # calculate alpha parameter from prop_presymptomatic (optimise outside of loop)
  alpha <- prop_presymptomatic_to_alpha(prop_presymptomatic = prop_presymptomatic)
